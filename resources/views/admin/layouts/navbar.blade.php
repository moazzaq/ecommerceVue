    ...
    <section class="sidebar">
        ...
        <i class="pull-right"></i>
                ...
                <ul class="treeview-menu" style="{{ active_menu('countries')[1] }}">
                    <li class=""><a href="{{ aurl('countries') }}">
                            <i class="fa fa-flag"></i>
        ...
        <i class="pull-right"></i>
            ...
            <li class="treeview {{ active_menu('departments')[0] }}">
                <a href="#">
                    ...
                    <span>{{ trans('admin.departments') }}</span>
                    <span class="pull-right-container">
        <i class="pull-right"></i>
      </span>
                </a>
        ...
        <i class="pull-right"></i>
                ...
                <ul class="treeview-menu" style="{{ active_menu('manufacturers')[1] }}">
                    <li class=""><a href="{{ aurl('shippings') }}"><i class="fa fa-truck"></i> {{ trans('admin.shippings') }}</a></li>
        ...
        <i class="pull-right"></i>
            ...
            <li class="treeview {{ active_menu('weights')[0] }}">
                <a href="#">
                    <i class="fa fa-tag"></i> <span>{{ trans('admin.weights') }}</span>
                    <span class="pull-right-container">
        <i class="pull-right"></i>
      </span>
                </a>
